...
#Part 3A of Assignment 1 - Practical Data Science
...
print("Data preprocessing step (3A) complete")

#create new graph
ratings["eval"].plot(kind="hist",bins=10,color="orange",edgecolor="white",linewidth=1.0)
