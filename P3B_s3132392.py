...
#Part 3B of Assignment 1 - Practical Data Science
...
ratings.fillna(ratings.median(axis=0), inplace=True)

#Finally, convert "age" to int (part of (Q1))
ratings["age"] = ratings["age"].astype(int)

print("Data preprocessing step (3B) complete")

#create new graph
ratings["beauty"].plot(kind="density")
